@if (session('success'))
    <div class="w-full">
        <div id="alertMessage" class="flex items-center p-4 mb-4 bg-green-200 rounded-lg" role="alert">
...
@if (session('failed'))
    <div class="w-full">
        <div id="alertMessage" class="flex items-center p-4 mb-4 bg-red-200 rounded-lg" role="alert">
            ...
            <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-red-200 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-300 inline-flex h-8 w-8" data-dismiss-target="#alertMessage" aria-label="Close">
                <span class="sr-only">Tutup</span>
                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                </svg>
...
@if (session('warning'))
    <div class="w-full">
        <div id="alertMessage" class="flex items-center p-4 mb-4 bg-yellow-200 rounded-lg" role="alert">
            ...
            <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-yellow-200 text-yellow-500 rounded-lg focus:ring-2 focus:ring-yellow-400 p-1.5 hover:bg-yellow-300 inline-flex h-8 w-8" data-dismiss-target="#alertMessage" aria-label="Close">
                <span class="sr-only">Tutup</span>
                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                </svg>
